import { ChevronDown, Folder, House } from "@nn/ui/icons";
...
export function LocationSelector({
  ...
  return (
    <Popover
      ...
      triggerClassName="flex h-10 w-full cursor-pointer items-center justify-start rounded-md border border-card-foreground/70 bg-background/50 px-3 text-sm font-normal backdrop-blur-sm hover:bg-accent/40"
      trigger={
        <>
      ...
      popupClassName="w-80 border-white/10 bg-background/70 p-0 shadow-xl backdrop-blur-md"
    >
