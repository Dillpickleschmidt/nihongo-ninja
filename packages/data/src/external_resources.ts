...
export const external_resources: Record<string, ExternalResource> = {
  ...
  "greetings-japanese-super-immersion": {
    ...
    external_url: "https://youtube.com/watch?v=po_6rnpP5mI",
  ...
  "common-expressions-japanese-super-immersion": {
    ...
    external_url: "https://youtube.com/watch?v=4PBR4w47wsQ",
    creator_id: "japanese_super_immersion",
    difficulty_rating: "easy",
    module_type: "video",
  },
  ...
  "japanese-super-immersion-nice-to-meet-you": {
    ...
    external_url: "https://youtube.com/watch?v=XBKeW87xsKc",
    creator_id: "japanese_super_immersion",
    module_type: "video",
    difficulty_rating: "easy",
  },
  "my-kikitori-conversation-1": {
    ...
    external_url: "https://mykikitori.com/lesson-1",
  ...
  "kikusasaizu-1-3": {
    ...
    external_url: "https://youtube.com/watch?v=VKETvr5uXsk",
    creator_id: "kikusasaizu",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  "kikusasaizu-2-2": {
    ...
    external_url: "https://youtube.com/watch?v=EdkEWPldx28",
    creator_id: "kikusasaizu",
    module_type: "video",
    difficulty_rating: "easy",
  },
  "kudasai-vs-onegaishimasu": {
    ...
    external_url: "https://youtube.com/watch?v=sVCeecJw8GM",
  ...
  "my-kikitori-at-a-cafe": {
    ...
    external_url: "https://mykikitori.com/lesson-2",
    creator_id: "mykikitori",
    module_type: "listening-material",
    difficulty_rating: "easy",
  },
  "unlearning-japanese": {
    ...
    external_url: "https://youtube.com/watch?v=BH9n_fNA7Z8",
  ...
  "your-japanese-voice": {
    ...
    external_url: "https://youtube.com/watch?v=Phr8z5X5Sf4",
    creator_id: "dogen",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  aizuchi: {
    ...
    external_url: "https://youtube.com/watch?v=r0io_xgmcSs",
  ...
  "my-kikitori-do-you-want-to-go-to-tokyo": {
    ...
    external_url: "https://mykikitori.com/lesson-3",
    creator_id: "mykikitori",
    module_type: "listening-material",
    difficulty_rating: "easy",
  },
  ...
  "long-form-conversation-immersion": {
    ...
    external_url: "https://youtube.com/watch?v=IJEn-9nAFQE",
    creator_id: "japanese_super_immersion",
    module_type: "video",
  ...
  "saying-no-naturally": {
    ...
    external_url: "https://youtube.com/watch?v=J9JdP6pA5LY",
  ...
  "immersion-with-yuta": {
    ...
    external_url: "https://youtube.com/watch?v=PFJZdvrghgI",
  ...
  "beginner-guide-to-konbini": {
    ...
    external_url: "https://youtube.com/watch?v=bPP3-GyFpYs",
    creator_id: "kaname_naito",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  sports: {
    ...
    external_url: "https://youtube.com/watch?v=MYuNYVhz3Gs",
    creator_id: "nihongo_learning",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  "why-your-speaking-sucks": {
    ...
    external_url: "https://youtube.com/watch?v=xLqnAI6mqDo",
  ...
  "how-verbs-work": {
    ...
    external_url: "https://youtube.com/watch?v=cGA6Tj9_lSg",
  ...
  colors: {
    title: "Colors",
    external_url: "https://youtube.com/watch?v=7XKDgSyu2yk",
    creator_id: "nihongo_learning",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  "comparing-sizes": {
    ...
    external_url: "https://youtube.com/watch?v=vD3_BO4KAdM",
    creator_id: "nihongo_learning",
    module_type: "video",
    difficulty_rating: "medium",
  },
  emotions: {
    title: "Emotions",
    external_url: "https://youtube.com/watch?v=nmmj3N3RnqY",
    creator_id: "nihongo_learning",
    module_type: "video",
    difficulty_rating: "easy",
  },
  ...
  "hobbies-with-yuta": {
    ...
    external_url: "https://youtube.com/watch?v=p37XUVrHP4E",
    creator_id: "nihongo_learning",
    module_type: "video",
    difficulty_rating: "medium",
  },
