...
export default function page() {
  ...
  return (
    <ContentBox
      nextButtonLink="/learn/chapter-17/practice/verbs-readings"
      nextButtonText="Next Lesson ->"
    >
      <h1 class="px-28 pb-6 pt-28 text-center text-4xl font-semibold">Verbs</h1>
      <Show when={data()}>
