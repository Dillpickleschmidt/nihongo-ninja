...
const learnTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: "Here, you'll find all the main content, organized by chapter.",
    placement: "top",
    overflowPadding: 75,
    scroll: true,
  },
  {
    ...
    content: "You can quickly navigate to any chapter by clicking on its dot.",
    ...
    content: (
      <div class="space-y-3">
        <p>
          ...
          occasionally there are additional lessons that fill in important gaps
          left uncovered by Genki.
        </p>
        <p>
          This particular lesson (and many others) has really good explanation
          videos handpicked from the internet for your maximum benefit.
        </p>
      </div>
    ),
    placement: "top-start",
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        ...
        <p>
          They include detailed explanations and mnemonics to help you remember
          them.
        </p>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        <p>
          If you want to see all the vocab for the chapter at a glance, click
          here.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        <p>
          Once you've finished glancing through the vocab, you can practice here
          using this intelligent tool to help you memorize it as quickly as
          possible.
        </p>
        <p>
          You only work with a handful of words at a time. First, you'll select
          the correct word in multiple-choice mode, then you'll type it to
          demonstrate you've mastered it.
        </p>
      </div>
    ),
    placement: "top-start",
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        <p>
          Many lessons have an accompanying <strong>Sentence Practice</strong>{" "}
          module. If you can master the sentences, you'll be able to use the
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        ...
        <p>
          If you just use Nihongo Ninja as a reference and want to find specific
          modules at a glance, select <strong>Module Type</strong>.
        </p>
      </div>
    ),
    class: "max-w-96",
  ...
  //   title: "Grammar Notes",
  //   content:
  //     "This page provides quick reference on grammar points (so you don't have do dive deep into the lessons when you're trying to remember something).",
  //   dialog: true,
  // },
  // {
  //   target: "#x-wa-y-desu",
  //   title: "Sample Grammar Note",
  //   content: "Click here to view one.",
  // },
  {
  ...
  },
  {
    ...
    content: (
      <div class="space-y-3">
        ...
        <p class="text-muted-foreground">
          Nihongo Ninja is still in alpha! If you have questions or bug reports,
          contact me @dillpickleschmidt
          <img src="/icons/discord.png" alt="" class="ml-1 inline h-4 w-4" /> on
          Discord.
        </p>
      </div>
    ),
