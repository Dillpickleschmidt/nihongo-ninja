...
export default function JapaneseWordOrderLesson() {
  return (
    <ContentBox nextButtonLink="/learn/chapter-3/practice-particles">
      ...
      <div class="space-y-6 px-8 pb-32 sm:px-16 md:px-24">
        ...
        <p>
          <span class="text-center font-japanese text-2xl">
            コーヒーはおいしいです。
          </span>
        ...
        <p class="mx-6 !mt-4 text-center text-muted-foreground">
