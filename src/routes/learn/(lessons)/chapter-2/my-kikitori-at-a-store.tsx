    ...
    <>
        ...
        <div class="relative w-full max-w-[1300px]">
          ...
          <div class="space-y-6 px-6 md:px-24">
            ...
            <p>
              ...
              <span class="text-xl font-bold">At a Store</span>, then answer the
              questions via the <span class="font-black">Take the Quiz!</span>{" "}
              button.
            </p>
            <p>
      ...
      <div class="absolute bottom-16 right-16">
        <A href="/learn/chapter-2/practice/all-vocab">
          <Button>Test your vocab knowledge {"->"}</Button>
        </A>
      </div>
    </>
  )
