...
export default function page() {
  return (
    <ContentBox nextButtonLink="/learn/chapter-3/word-order">
      ...
      <div class="space-y-6 px-8 sm:px-16 md:px-24">
        ...
        <p class="mx-12 text-2xl">
          ...
          <span class="text-base text-muted-foreground">(80/20 Japanese)</span>.
        </p>
        <p>
        ...
        <p class="text-center">I eat sushi.</p>
        <ul>
          <li>
        ...
        <div class="relative w-full">
          <p class="absolute font-bold text-red-500">Incorrect</p>
          <p class="text-center">
            <span class="line-through">Sushi eat I.</span>
          </p>
        </div>
        <p>
        ...
        <ul class="list-inside list-disc space-y-2">
          <li>
            <span class="font-japanese text-xl">
              <span class="underline underline-offset-4">
                本<span class="font-bold text-red-500">を</span>
              </span>
              読みます。
            </span>{" "}
            - I read a book.
          ...
          <li>
            <span class="font-japanese text-xl">
              <span class="underline underline-offset-4">
                水<span class="font-bold text-red-500">を</span>
              </span>
              飲みます。
            </span>{" "}
            - I drink water.
          ...
          <li>
            <span class="font-japanese text-xl">
              <span class="underline underline-offset-4">
                日本語<span class="font-bold text-red-500">を</span>
              </span>
              勉強します。
            </span>{" "}
            - I study Japanese.
        ...
        <p class="italic">
          ...
          <a
            ...
            target="_blank"
            class="font-semibold not-italic text-sky-400 underline"
          >
        ...
        <div class="!mt-2 flex w-full items-center">
          ...
          <p class="w-3/4">
            <span class="font-japanese text-xl line-through">
              私は本ゆっくり
              <span class="font-bold text-red-500">を</span>読みます。
            </span>
          </p>
        </div>
        <div class="flex w-full items-center">
          ...
          <p class="w-3/4">
            <span class="font-japanese text-xl">
              私は本<span class="font-bold text-red-500">を</span>
              ゆっくり読みます。
            </span>
            {"->"} I read books slowly.
          </p>
        ...
        <p>
          ...
          <span class="text-base text-muted-foreground">(slowly)</span> instead
