    ...
    <Show when={cardOne && cardTwo}>
      ...
      >
        <div class="relative flex w-full xl:w-1/2">
          <div class="mr-2 mt-10 flex h-full max-h-[450px] justify-center font-medium sm:mr-6">
            <p class="japaneseText mr-1 font-japanese text-2xl text-red-400">
              ︵{cardOne.hiragana}︶
            </p>
            <p class="japaneseText font-japanese text-5xl">{cardOne.word}</p>
          </div>
        ...
        <Show when={!props.single}>
          <div class="relative flex w-full xl:w-1/2">
            <div class="mr-2 mt-10 flex h-full max-h-[450px] justify-center font-medium sm:mr-6">
              <p class="japaneseText mr-1 font-japanese text-2xl text-orange-300 saturate-50">
                ︵{cardTwo.hiragana}︶
              </p>
              <p class="japaneseText font-japanese text-5xl">{cardTwo.word}</p>
            </div>
