...
export default function CharacterBox(props: CharacterBoxProps) {
  ...
  return (
    <div
      class={`relative flex h-48 justify-center rounded-[12px] bg-card text-3xl shadow-lg shadow-[#645947] ${props.class}`}
    >
      ...
      >
        <input
          type="text"
          class={`h-14 w-28 border-2 bg-[#191919] bg-opacity-0 ${props.innerBorderColor || "border-[#aaaaaa]"} rounded-xl border-dashed text-center`}
